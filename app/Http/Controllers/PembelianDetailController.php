...
class PembelianDetailController extends Controller
{
    ...
    public function data($id)
    {
        ...
        foreach ($detail as $item) {
            ...
            $row['harga_beli']  = 'Rp. <input type="number" class="form-control input-sm price" id="price-'. $item->id_pembelian_detail .'" data-id="' . $item->id_pembelian_detail . '" value="' . $item->harga_beli . '">';
            $row['jumlah']      = '<input type="number" class="form-control input-sm quantity" id="qty-'. $item->id_pembelian_detail .'" data-id="'. $item->id_pembelian_detail .'" value="'. $item->jumlah .'">';
